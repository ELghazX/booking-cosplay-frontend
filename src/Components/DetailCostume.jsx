    ...
    <div className="bg-white rounded-2xl shadow-lg max-w-screen-xl w-full flex flex-col md:flex-row overflow-hidden mx-auto min-h-[calc(100vh-160px)]">
      ...
      <div className="md:w-1/2 w-full p-6 space-y-6 flex flex-col">
        <div>
          ...
          <div className="relative mt-1">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <img src="/icon-costume.png" alt="accessory icon" className="h-5 w-5 text-gray-400" />
            </div>
            <input
              type="text"
        ...
        <div>
          ...
          <div className="relative mt-1">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <img src="/icon-chara.png" alt="type icon" className="h-5 w-5 text-gray-400" />
            </div>
            <input
              type="text"
        ...
        <div>
          ...
          <div className="relative mt-1">
            ...
            <input
              ...
              disabled
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-rose-500 focus:border-rose-500 py-2 text-lg pl-10"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-1">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <img src="/icon-ukuran.png" alt="date icon" className="h-5 w-5 text-gray-400" />
            </div>
            <input
              type="text"
        ...
        <div>
          ...
          <div className="relative mt-1">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <img src="/icon-gender.png" alt="date icon" className="h-5 w-5 text-gray-400" />
            </div>
            <input
              type="date"
              name="date"
